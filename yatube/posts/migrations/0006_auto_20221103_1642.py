# Generated by Django 2.2.16 on 2022-11-03 13:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(help_text='Введите слаг группы', unique=True, verbose_name='Slug группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
            field=models.CharField(help_text='Введите тайтл группы', max_length=200, verbose_name='Title группы'),
        ),
        migrations.AlterField(
            model_name='post',
            name='author',
